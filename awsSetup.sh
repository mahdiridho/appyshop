...
aws --profile crossaccount s3 cp s3://jc.demo.shop/ s3://jc.demo.shop/ --exclude "*" --include "/data/**/*.json" "/src/**/*.json" --metadata-directive REPLACE --sse AES256 --cache-control max-age=604800 --content-type application/json
